...
export default function ScrollToTop() {
    ...
    return (<> {scrollThresh && <div className='scrollToTopButton ' onClick={scrollup} >
        <div >
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" className="bi bi-arrow-up-square" viewBox="0 0 16 16">
